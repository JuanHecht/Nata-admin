...
function style2(props, keys) {
  ...
  return Object.keys(props).map((prop) => resolveCssProperty(props, keys, prop, transformer2)).reduce(merge_default, {});
}
...
function private_safeEmphasize(color3, coefficient, warning) {
  try {
    return private_safeEmphasize(color3, coefficient);
  } catch (error) {
    if (warning && true) {
      console.warn(warning);
    }
...
function useCurrentColorScheme(options) {
  ...
  const setMode = React26.useCallback((mode2) => {
    setState((currentState) => {
      if (mode2 === currentState.mode) {
        return currentState;
      }
      const newMode = !mode2 ? defaultMode : mode2;
      try {
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider2({
    ...
    const ctx2 = React27.useContext(ColorSchemeContext);
...
var useChartDimensions = (width2, height2, margin2) => {
  ...
  const drawingArea = React33.useMemo(() => ({
...
var DrawingContext = React34.createContext({
  top: 0,
  left: 0,
  bottom: 0,
  right: 0,
...
var SVGContext = React34.createContext({
  current: null
});
function DrawingProvider(props) {
  ...
  return (0, import_jsx_runtime14.jsx)(SVGContext.Provider, {
    value: svgRef,
    children: (0, import_jsx_runtime14.jsx)(DrawingContext.Provider, {
      value: drawingArea,
      children
    })
  });
...
true ? DrawingProvider.propTypes = {
  ...
  svgRef: import_prop_types20.default.shape({
...
var SeriesContext = React35.createContext({});
...
function SeriesContextProvider(props) {
  ...
  const formattedSeries = React35.useMemo(() => formatSeries(series, typeof colors3 === "function" ? colors3(theme.palette.mode) : colors3, dataset), [series, colors3, theme.palette.mode, dataset]);
  return (0, import_jsx_runtime15.jsx)(SeriesContext.Provider, {
...
function InteractionProvider(props) {
  ...
  return (0, import_jsx_runtime16.jsx)(InteractionContext.Provider, {
    value,
    children
  });
}
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react16.forwardRef)((givenProps, givenRef) => {
    ...
    return React37.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React38.createElement(Provider, { value: props }, children);
};
var ctx = makeContext(SpringContext, {});
SpringContext.Provider = ctx.Provider;
SpringContext.Consumer = ctx.Consumer;
function makeContext(target, init) {
  Object.assign(target, React38.createContext(init));
...
var getValueExtremum = (params) => {
  ...
  return Object.keys(series).filter((seriesId) => series[seriesId].yAxisKey === axis.id || isDefaultAxis && series[seriesId].yAxisKey === void 0).reduce((acc, seriesId) => {
    const [seriesMin, seriesMax] = series[seriesId].stackedData.reduce((seriesAcc, values2) => [Math.min(...values2, ...seriesAcc[0] === null ? [] : [seriesAcc[0]]), Math.max(...values2, ...seriesAcc[1] === null ? [] : [seriesAcc[1]])], series[seriesId].stackedData[0]);
...
var CartesianContext = React40.createContext({
  xAxis: {},
  yAxis: {},
  xAxisIds: [],
  yAxisIds: []
...
function CartesianContextProvider(props) {
  ...
  const formattedSeries = React40.useContext(SeriesContext);
  const drawingArea = React40.useContext(DrawingContext);
  const xAxis = React40.useMemo(() => inXAxis == null ? void 0 : inXAxis.map((axisConfig) => {
  ...
  const yAxis = React40.useMemo(() => inYAxis == null ? void 0 : inYAxis.map((axisConfig) => {
    const dataKey = axisConfig.dataKey;
    if (dataKey === void 0 || axisConfig.data !== void 0) {
      return axisConfig;
    }
  ...
  return (0, import_jsx_runtime17.jsx)(CartesianContext.Provider, {
    value,
    children
  });
}
...
var useAxisEvents = (disableAxisListener) => {
  const svgRef = React41.useContext(SVGContext);
  const {
    width: width2,
    height: height2,
    top: top3,
  ...
  const {
    ...
    xAxisIds,
    yAxisIds
  } = React41.useContext(CartesianContext);
  const {
    dispatch
  } = React41.useContext(InteractionContext);
  const usedXAxis = xAxisIds[0];
  const usedYAxis = yAxisIds[0];
  const mousePosition = React41.useRef({
    x: -1,
    y: -1
  });
  React41.useEffect(() => {
    ...
    const handleMouseMove = (event) => {
      ...
      const outsideX = svgPt.x < left3 || svgPt.x > left3 + width2;
      const outsideY = svgPt.y < top3 || svgPt.y > top3 + height2;
...
var _excluded17 = ["children", "width", "height", "viewBox", "disableAxisListener", "className"];
var ChartChartsSurfaceStyles = styled_default2("svg", {
  name: "MuiChartsSurface",
  slot: "Root"
})(() => ({}));
var ChartsSurface = React42.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width: width2,
    height: height2,
  ...
  return (0, import_jsx_runtime19.jsxs)(ChartChartsSurfaceStyles, _extends({
    ...
    children: [(0, import_jsx_runtime18.jsx)("title", {
      children: props.title
    }), (0, import_jsx_runtime18.jsx)("desc", {
      children: props.desc
    }), children]
  }));
});
...
var HighlighContext = React43.createContext({
  item: null,
  scope: defaultScope,
  dispatch: () => null
});
...
function HighlightProvider(props) {
  ...
  const [data, dispatch] = React43.useReducer(dataReducer2, {
    item: null,
    scope: defaultScope
  });
  const value = React43.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
var ChartContainer = React44.forwardRef(function ChartContainer2(props, ref) {
  ...
  useReducedMotion2();
  return (0, import_jsx_runtime21.jsx)(DrawingProvider, {
    width: width2,
    height: height2,
    margin: margin2,
    svgRef,
    children: (0, import_jsx_runtime21.jsx)(SeriesContextProvider, {
      series,
      colors: colors3,
      dataset,
      children: (0, import_jsx_runtime21.jsx)(CartesianContextProvider, {
        xAxis,
        yAxis,
        dataset,
        children: (0, import_jsx_runtime21.jsx)(InteractionProvider, {
          children: (0, import_jsx_runtime21.jsx)(HighlightProvider, {
            children: (0, import_jsx_runtime21.jsx)(ChartsSurface, {
              width: width2,
              height: height2,
              ref: handleRef,
              sx,
...
var _excluded18 = ["width", "height"];
var useChartDimensions2 = (inWidth, inHeight) => {
  const rootRef = React45.useRef(null);
  const displayError = React45.useRef(false);
  const [width2, setWidth] = React45.useState(0);
  const [height2, setHeight] = React45.useState(0);
  const computeSize = React45.useCallback(() => {
  ...
  return [rootRef, inWidth != null ? inWidth : width2, inHeight != null ? inHeight : height2];
};
...
var ResponsiveChartContainer = React45.forwardRef(function ResponsiveChartContainer2(props, ref) {
  ...
  const [containerRef, width2, height2] = useChartDimensions2(inWidth, inHeight);
  return (0, import_jsx_runtime22.jsx)(ResizableContainer, {
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    },
    children: width2 && height2 ? (0, import_jsx_runtime22.jsx)(ChartContainer, _extends({}, other, {
      width: width2,
      height: height2,
      ref
    })) : null
...
var _excluded20 = ["x", "y", "style", "text", "ownerState"];
var _excluded25 = ["angle", "textAnchor", "dominantBaseline"];
function ChartsText(props) {
  const {
    ...
    style: styleProps,
    text
  } = props, textProps = _objectWithoutPropertiesLoose(props, _excluded20);
  const _ref = styleProps != null ? styleProps : {}, {
    angle,
    textAnchor,
    dominantBaseline
  } = _ref, style4 = _objectWithoutPropertiesLoose(_ref, _excluded25);
  const wordsByLines = React49.useMemo(() => getWordsByLines({
    style: style4,
...
var _excluded21 = ["scale", "tickNumber", "reverse"];
...
function ChartsXAxis(inProps) {
  ...
  const {
    xAxisIds
  } = React51.useContext(CartesianContext);
  const _React$useContext = React51.useContext(CartesianContext), _ref = (_props$axisId = props.axisId) != null ? _props$axisId : xAxisIds[0], {
    xAxis: {
      [_ref]: {
        scale: xScale,
        tickNumber,
  ...
  } = _React$useContext, settings = _objectWithoutPropertiesLoose(_React$useContext.xAxis[_ref], _excluded21);
  ...
  return (0, import_jsx_runtime26.jsxs)(AxisRoot, {
    transform: `translate(0, ${position3 === "bottom" ? top3 + height2 : top3})`,
    className: classes.root,
    children: [!disableLine && (0, import_jsx_runtime25.jsx)(Line, _extends({
      x1: xScale.range()[0],
      x2: xScale.range()[1],
      ...
      return (0, import_jsx_runtime26.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime25.jsx)(Tick, _extends({
          y2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && (0, import_jsx_runtime25.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
    ...
    }), label && (0, import_jsx_runtime25.jsx)("g", {
      className: classes.label,
      children: (0, import_jsx_runtime25.jsx)(Label, _extends({}, labelRefPoint, axisLabelProps, {
        text: label
      }))
    })]
  });
...
function ChartsYAxis(inProps) {
  ...
  const {
    yAxisIds
  } = React52.useContext(CartesianContext);
  const _React$useContext = React52.useContext(CartesianContext), _ref = (_props$axisId = props.axisId) != null ? _props$axisId : yAxisIds[0], {
    yAxis: {
      [_ref]: {
        scale: yScale,
        tickNumber
    ...
    children: [!disableLine && (0, import_jsx_runtime27.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime28.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime27.jsx)(Tick, _extends({
          ...
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && (0, import_jsx_runtime27.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: formattedValue.toString()
        }, axisTickLabelProps))]
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime30.jsxs)(React53.Fragment, {
    children: [topId && (0, import_jsx_runtime29.jsx)(ChartsXAxis, _extends({}, topAxisProps, {
      position: "top",
      axisId: topId
    })), bottomId && (0, import_jsx_runtime29.jsx)(ChartsXAxis, _extends({}, bottomAxisProps, {
      position: "bottom",
      axisId: bottomId
    })), leftId && (0, import_jsx_runtime29.jsx)(ChartsYAxis, _extends({}, leftAxisProps, {
      position: "left",
      axisId: leftId
    })), rightId && (0, import_jsx_runtime29.jsx)(ChartsYAxis, _extends({}, rightAxisProps, {
      position: "right",
      axisId: rightId
    }))]
  });
...
true ? ChartsAxis.propTypes = {
   ...
   */
  bottomAxis: import_prop_types26.default.oneOfType([import_prop_types26.default.shape({
   ...
   */
  leftAxis: import_prop_types26.default.oneOfType([import_prop_types26.default.shape({
    axisId: import_prop_types26.default.oneOfType([import_prop_types26.default.number, import_prop_types26.default.string]),
    classes: import_prop_types26.default.object,
    disableLine: import_prop_types26.default.bool,
    disableTicks: import_prop_types26.default.bool,
   ...
   * @default null
   */
  rightAxis: import_prop_types26.default.oneOfType([import_prop_types26.default.shape({
    axisId: import_prop_types26.default.oneOfType([import_prop_types26.default.number, import_prop_types26.default.string]),
    classes: import_prop_types26.default.object,
    disableLine: import_prop_types26.default.bool,
    disableTicks: import_prop_types26.default.bool,
   ...
   * @default null
   */
  topAxis: import_prop_types26.default.oneOfType([import_prop_types26.default.shape({
    axisId: import_prop_types26.default.oneOfType([import_prop_types26.default.number, import_prop_types26.default.string]),
    classes: import_prop_types26.default.object,
    disableLine: import_prop_types26.default.bool,
    disableTicks: import_prop_types26.default.bool,
...
var Portal = React54.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children,
    container,
    disablePortal = false
  } = props;
  const [mountNode, setMountNode] = React54.useState(null);
  const handleRef = useForkRef(React54.isValidElement(children) ? children.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React54.isValidElement(children)) {
      ...
      return React54.cloneElement(children, newProps);
    }
    return (0, import_jsx_runtime31.jsx)(React54.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime31.jsx)(React54.Fragment, {
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime33.jsx)(React56.Fragment, {
...
function useMouseTracker() {
  const svgRef = React57.useContext(SVGContext);
...
var ChartsTooltipMark = styled_default2(Box_default, {
  name: "MuiChartsTooltip",
  slot: "Mark"
})(({
  theme,
...
true ? DefaultChartsItemTooltipContent.propTypes = {
   ...
   */
  series: import_prop_types30.default.shape({
    color: import_prop_types30.default.string,
    data: import_prop_types30.default.oneOfType([import_prop_types30.default.arrayOf(import_prop_types30.default.number), import_prop_types30.default.arrayOf(import_prop_types30.default.number), import_prop_types30.default.arrayOf(import_prop_types30.default.shape({
      ...
      x: import_prop_types30.default.number.isRequired,
      y: import_prop_types30.default.number.isRequired
    })), import_prop_types30.default.arrayOf(import_prop_types30.default.shape({
    ...
    id: import_prop_types30.default.oneOfType([import_prop_types30.default.number, import_prop_types30.default.string]).isRequired,
    type: import_prop_types30.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired,
    valueFormatter: import_prop_types30.default.func.isRequired
  }).isRequired,
...
function ChartsItemTooltipContent(props) {
  ...
  const series = React59.useContext(SeriesContext)[itemData.type].series[itemData.seriesId];
...
true ? ChartsItemTooltipContent.propTypes = {
  ...
  content: import_prop_types31.default.elementType,
  contentProps: import_prop_types31.default.shape({
    ...
    series: import_prop_types31.default.shape({
      color: import_prop_types31.default.string,
      data: import_prop_types31.default.oneOfType([import_prop_types31.default.arrayOf(import_prop_types31.default.number), import_prop_types31.default.arrayOf(import_prop_types31.default.number), import_prop_types31.default.arrayOf(import_prop_types31.default.shape({
        ...
        x: import_prop_types31.default.number.isRequired,
        y: import_prop_types31.default.number.isRequired
      })), import_prop_types31.default.arrayOf(import_prop_types31.default.shape({
        color: import_prop_types31.default.string.isRequired,
        endAngle: import_prop_types31.default.number.isRequired,
        formattedValue: import_prop_types31.default.string.isRequired,
        id: import_prop_types31.default.oneOfType([import_prop_types31.default.number, import_prop_types31.default.string]).isRequired,
        index: import_prop_types31.default.number.isRequired,
        label: import_prop_types31.default.string,
        padAngle: import_prop_types31.default.number.isRequired,
        startAngle: import_prop_types31.default.number.isRequired,
        value: import_prop_types31.default.number.isRequired
      }))]).isRequired,
      highlightScope: import_prop_types31.default.shape({
        faded: import_prop_types31.default.oneOf(["global", "none", "series"]),
        highlighted: import_prop_types31.default.oneOf(["item", "none", "series"])
      }),
      id: import_prop_types31.default.oneOfType([import_prop_types31.default.number, import_prop_types31.default.string]).isRequired,
      type: import_prop_types31.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired,
      valueFormatter: import_prop_types31.default.func.isRequired
    }),
...
var Typography = React60.forwardRef(function Typography2(inProps, ref) {
...
function DefaultChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime38.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.root,
    children: (0, import_jsx_runtime39.jsxs)(ChartsTooltipTable, {
      className: classes.table,
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime38.jsx)("thead", {
        ...
        children: series.map(({
          ...
          return (0, import_jsx_runtime39.jsxs)(ChartsTooltipRow, {
            className: classes.row,
            children: [(0, import_jsx_runtime38.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
   ...
   */
  axis: import_prop_types33.default.object.isRequired,
  /**
   * Data identifying the triggered axis.
   */
  axisData: import_prop_types33.default.shape({
    x: import_prop_types33.default.shape({
      index: import_prop_types33.default.number,
      value: import_prop_types33.default.oneOfType([import_prop_types33.default.instanceOf(Date), import_prop_types33.default.number, import_prop_types33.default.string]).isRequired
    }),
    y: import_prop_types33.default.shape({
      index: import_prop_types33.default.number,
      value: import_prop_types33.default.oneOfType([import_prop_types33.default.instanceOf(Date), import_prop_types33.default.number, import_prop_types33.default.string]).isRequired
    })
  }).isRequired,
   ...
   */
  axisValue: import_prop_types33.default.any.isRequired,
  /**
   * Override or extend the styles applied to the component.
   */
...
function ChartsAxisTooltipContent(props) {
  ...
  const series = React62.useContext(SeriesContext);
  const USED_AXIS_ID = isXaxis ? xAxisIds[0] : yAxisIds[0];
  const relevantSeries = React62.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React62.useMemo(() => {
  ...
  return (0, import_jsx_runtime40.jsx)(Content, _extends({}, chartTooltipContentProps));
}
true ? ChartsAxisTooltipContent.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "yarn proptypes"  |
  // ----------------------------------------------------------------------
  axisData: import_prop_types34.default.shape({
    x: import_prop_types34.default.shape({
      index: import_prop_types34.default.number,
      value: import_prop_types34.default.oneOfType([import_prop_types34.default.instanceOf(Date), import_prop_types34.default.number, import_prop_types34.default.string]).isRequired
    }),
    y: import_prop_types34.default.shape({
      index: import_prop_types34.default.number,
      value: import_prop_types34.default.oneOfType([import_prop_types34.default.instanceOf(Date), import_prop_types34.default.number, import_prop_types34.default.string]).isRequired
    })
  }).isRequired,
  ...
  contentProps: import_prop_types34.default.shape({
    axis: import_prop_types34.default.object,
    axisData: import_prop_types34.default.shape({
      x: import_prop_types34.default.shape({
        index: import_prop_types34.default.number,
        value: import_prop_types34.default.oneOfType([import_prop_types34.default.instanceOf(Date), import_prop_types34.default.number, import_prop_types34.default.string]).isRequired
    ...
    axisValue: import_prop_types34.default.any,
    classes: import_prop_types34.default.object,
    dataIndex: import_prop_types34.default.number,
    series: import_prop_types34.default.arrayOf(import_prop_types34.default.object),
...
function ChartsTooltip(props) {
  ...
  return (0, import_jsx_runtime41.jsx)(NoSsr, {
    children: popperOpen && (0, import_jsx_runtime41.jsx)(PopperComponent, _extends({}, popperProps, {
      children: trigger === "item" ? (0, import_jsx_runtime41.jsx)(ChartsItemTooltipContent, {
        ...
        classes
      }) : (0, import_jsx_runtime41.jsx)(ChartsAxisTooltipContent, {
...
true ? ChartsTooltip.propTypes = {
   ...
   */
  axisContent: import_prop_types35.default.elementType,
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   */
  itemContent: import_prop_types35.default.elementType,
  /**
   * The props used for each component slot.
   * @default {}
   */
   ...
   * @default 'item'
   */
  trigger: import_prop_types35.default.oneOf(["axis", "item", "none"])
} : void 0;
...
function DefaultChartsLegend(props) {
  ...
  const padding2 = React64.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  ...
  const seriesWithPosition = React64.useMemo(() => {
    let x2 = 0;
    let y2 = 0;
    ...
    switch (position3.horizontal) {
      case "left":
        ...
        break;
      case "right":
        gapX = totalWidth - padding2.right - totalWidthUsed;
        break;
      default:
    ...
    switch (position3.vertical) {
      case "top":
        ...
        break;
      case "bottom":
        gapY = totalHeight - padding2.bottom - totalHeightUsed;
        break;
      default:
  ...
  }, [seriesToDisplay, position3.horizontal, position3.vertical, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap, padding2.left, padding2.right, padding2.top, padding2.bottom, totalWidth, totalHeight]);
  if (hidden) {
    return null;
  }
  return (0, import_jsx_runtime42.jsx)(NoSsr, {
    children: (0, import_jsx_runtime42.jsx)(ChartsLegendRoot, {
      className: classes.root,
      children: seriesWithPosition.map(({
        ...
        positionX,
        positionY
      }) => (0, import_jsx_runtime43.jsxs)("g", {
        className: classes.series,
        transform: `translate(${positionX} ${positionY})`,
        children: [(0, import_jsx_runtime42.jsx)("rect", {
          className: classes.mark,
          y: -itemMarkHeight / 2,
          width: itemMarkWidth,
...
function ChartsLegend(inProps) {
  ...
  const drawingArea = React64.useContext(DrawingContext);
  const series = React64.useContext(SeriesContext);
...
true ? ChartsLegend.propTypes = {
   ...
   */
  direction: import_prop_types36.default.oneOf(["column", "row"]),
  /**
...
function ChartsAxisHighlight(props) {
  ...
  const {
    ...
    yAxisIds,
    yAxis
  } = React66.useContext(CartesianContext);
  ...
  return (0, import_jsx_runtime45.jsxs)(React66.Fragment, {
    children: [xAxisHighlight === "band" && axis.x !== null && isBandScale(xScale) && (0, import_jsx_runtime44.jsx)(ChartsAxisHighlightPath, {
    ...
    }), yAxisHighlight === "band" && axis.y !== null && isBandScale(yScale) && (0, import_jsx_runtime44.jsx)(ChartsAxisHighlightPath, {
...
var useInteractionItemProps = (scope) => {
  ...
  } = React67.useContext(HighlighContext);
...
var _excluded31 = ["id", "dataIndex", "classes", "color", "highlightScope", "onClick", "isFaded", "isHighlighted", "startAngle", "endAngle", "paddingAngle", "innerRadius", "outerRadius", "cornerRadius"];
...
function PieArc(props) {
  ...
  return (0, import_jsx_runtime46.jsx)(PieArcRoot, _extends({
...
var _excluded33 = ["slots", "slotProps", "innerRadius", "outerRadius", "cornerRadius", "paddingAngle", "id", "highlightScope", "highlighted", "faded", "data", "onClick", "skipAnimation"];
...
function PieArcPlot(props) {
  ...
  return (0, import_jsx_runtime47.jsx)("g", _extends({}, other, {
    children: transition((_ref, item, _, index2) => {
      ...
      return (0, import_jsx_runtime47.jsx)(Arc, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
function PieArcLabel(props) {
  ...
  return (0, import_jsx_runtime48.jsx)(PieArcLabelRoot, _extends({
    className: classes.root
  }, other, {
    style: _extends({
...
var _excluded35 = ["slots", "slotProps", "innerRadius", "outerRadius", "arcLabelRadius", "cornerRadius", "paddingAngle", "id", "highlightScope", "highlighted", "faded", "data", "arcLabel", "arcLabelMinAngle", "skipAnimation"];
...
function PieArcLabelPlot(props) {
  ...
  return (0, import_jsx_runtime49.jsx)("g", _extends({}, other, {
    children: transition((_ref, item) => {
      ...
      return (0, import_jsx_runtime49.jsx)(ArcLabel, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
function PiePlot(props) {
  ...
  return (0, import_jsx_runtime51.jsxs)("g", {
    children: [seriesOrder.map((seriesId) => {
      ...
      const cx = getPercentageValue(cxParam != null ? cxParam : "50%", width2);
      const cy = getPercentageValue(cyParam != null ? cyParam : "50%", height2);
      return (0, import_jsx_runtime50.jsx)("g", {
        transform: `translate(${left3 + cx}, ${top3 + cy})`,
        children: (0, import_jsx_runtime50.jsx)(PieArcPlot, {
          innerRadius,
          outerRadius,
          cornerRadius,
          paddingAngle,
      ...
      return (0, import_jsx_runtime50.jsx)("g", {
        transform: `translate(${left3 + cx}, ${top3 + cy})`,
        children: (0, import_jsx_runtime50.jsx)(PieArcLabelPlot, {
          innerRadius,
...
function PieChart(props) {
  ...
  const margin2 = _extends({}, defaultMargin, marginProps);
  return (0, import_jsx_runtime53.jsxs)(ResponsiveChartContainer, {
    ...
    children: [(0, import_jsx_runtime52.jsx)(ChartsAxis, {
      ...
      slots,
      slotProps
    })), (0, import_jsx_runtime52.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), (0, import_jsx_runtime52.jsx)(ChartsTooltip, _extends({}, tooltip)), children]
  });
}
true ? PieChart.propTypes = {
   ...
   * @default null
   */
  bottomAxis: import_prop_types43.default.oneOfType([import_prop_types43.default.shape({
   ...
   * @default null
   */
  leftAxis: import_prop_types43.default.oneOfType([import_prop_types43.default.shape({
    axisId: import_prop_types43.default.oneOfType([import_prop_types43.default.number, import_prop_types43.default.string]),
    classes: import_prop_types43.default.object,
    disableLine: import_prop_types43.default.bool,
    disableTicks: import_prop_types43.default.bool,
   ...
   * @default null
   */
  rightAxis: import_prop_types43.default.oneOfType([import_prop_types43.default.shape({
    axisId: import_prop_types43.default.oneOfType([import_prop_types43.default.number, import_prop_types43.default.string]),
    classes: import_prop_types43.default.object,
    disableLine: import_prop_types43.default.bool,
    disableTicks: import_prop_types43.default.bool,
  ...
  series: import_prop_types43.default.arrayOf(import_prop_types43.default.shape({
    ...
    arcLabelRadius: import_prop_types43.default.oneOfType([import_prop_types43.default.number, import_prop_types43.default.string]),
    color: import_prop_types43.default.string,
    cornerRadius: import_prop_types43.default.number,
    cx: import_prop_types43.default.oneOfType([import_prop_types43.default.number, import_prop_types43.default.string]),
    cy: import_prop_types43.default.oneOfType([import_prop_types43.default.number, import_prop_types43.default.string]),
    ...
    endAngle: import_prop_types43.default.number,
    ...
    highlightScope: import_prop_types43.default.shape({
      faded: import_prop_types43.default.oneOf(["global", "none", "series"]),
      highlighted: import_prop_types43.default.oneOf(["item", "none", "series"])
    }),
    id: import_prop_types43.default.oneOfType([import_prop_types43.default.number, import_prop_types43.default.string]),
    innerRadius: import_prop_types43.default.oneOfType([import_prop_types43.default.number, import_prop_types43.default.string]),
    outerRadius: import_prop_types43.default.oneOfType([import_prop_types43.default.number, import_prop_types43.default.string]),
    paddingAngle: import_prop_types43.default.number,
    sortingValues: import_prop_types43.default.oneOfType([import_prop_types43.default.oneOf(["asc", "desc", "none"]), import_prop_types43.default.func]),
    startAngle: import_prop_types43.default.number,
    type: import_prop_types43.default.oneOf(["pie"]),
   ...
   * @default null
   */
  topAxis: import_prop_types43.default.oneOfType([import_prop_types43.default.shape({
    axisId: import_prop_types43.default.oneOfType([import_prop_types43.default.number, import_prop_types43.default.string]),
    classes: import_prop_types43.default.object,
    disableLine: import_prop_types43.default.bool,
    disableTicks: import_prop_types43.default.bool,
  ...
  xAxis: import_prop_types43.default.arrayOf(import_prop_types43.default.shape({
    ...
    position: import_prop_types43.default.oneOf(["bottom", "left", "right", "top"]),
